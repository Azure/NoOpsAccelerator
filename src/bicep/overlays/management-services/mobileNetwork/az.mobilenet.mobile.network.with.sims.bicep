...
module mobileNetwork '../../../azresources/Modules/Microsoft.MobileNetwork/mobileNetworks/az.mobilenet.mobile.network.bicep' = {
...
module resSimGroups '../../../azresources/Modules/Microsoft.MobileNetwork/simGroups/az.mobilenet.sim.group.bicep' = [for simGroup in simGroups: {
...
module resSims '../../../azresources/Modules/Microsoft.MobileNetwork/sims/az.mobilenet.sim.bicep' = [for sim in sims: {
...
module resDataNetwork '../../../azresources/Modules/Microsoft.MobileNetwork/mobileNetworks/dataNetworks/az.mobilenet.data.network.bicep' = [for dataNetwork in dataNetworks: {
...
module resPacketCoreDataPlanes '../../../azresources/Modules/Microsoft.MobileNetwork/packetCoreControlPlanes/packetCoreDataPlanes/az.mobilenet.packet.core.data.plane.bicep' = [for packetCoreDataPlane in packetCoreDataPlanes: {
...
module resSlices '../../../azresources/Modules/Microsoft.MobileNetwork/mobileNetworks/slices/az.mobilenet.slice.bicep' = [for slice in slices: {
...
module resServices '../../../azresources/Modules/Microsoft.MobileNetwork/mobileNetworks/services/az.mobilenet.service.bicep' = [for service in services: {
...
module resSimPolicies '../../../azresources/Modules/Microsoft.MobileNetwork/mobileNetworks/simPolicies/az.mobilenet.sim.policy.bicep' = [for simPolicy in simPolicies: {
...
module resPacketCoreControlPlanes '../../../azresources/Modules/Microsoft.MobileNetwork/packetCoreControlPlanes/az.mobilenet.packet.core.control.plane.bicep' = [for packetCoreControlPlane in packetCoreControlPlanes: {
